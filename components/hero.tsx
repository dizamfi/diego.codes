    ...
    <section className="pt-20 md:pt-28 text-center relative">
      ...
      >
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-white/80">
          <Balancer>
            Desarrollador Fullstack. Disfruto creando interfaces modernas con <strong>Next.js</strong> y <strong>React</strong>, dando vida a las experiencias con <strong>Framer Motion</strong> y construyendo <strong>backends escalables</strong> con Node.js y Supabase.
          </Balancer>
        </p>
